                ...
                <div class="w-50 mx-auto">
                    <form action="<%=request.getContextPath()%>/register" method="post" >
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="inEmail" name="email" aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">password</label>
                            <input type="password" class="form-control" id="inPass" name="password" placeholder="Password">
                        </div>
...
<!--                         </div> -->
      ...
      <script src="../../wwwroot/js/main.js" type="text/javascript"></script>
  </body>
</html>